...
class UsageExamplesScreen extends React.Component {
  ...
  renderLoginButton () {
    return (
      <XButton onPressDelegate={NavigationActions.login}>
        {I18n.t('signIn')}
      </XButton>
    )
  }
  ...
  renderLogoutButton () {
    return (
      <XButton onPressDelegate={this.props.logout}>
        {I18n.t('logOut')}
      </XButton>
    )
  }
  ...
  renderUsageExamples () {
    ...
    return (
      <View>
        ...
        <View>
          <XButton text='Listview' onPressDelegate={NavigationActions.listviewExample} />
        </View>
        <View>
          <XButton text='Listview Grid' onPressDelegate={NavigationActions.listviewGridExample} />
        </View>
        <View>
          <XButton text='Listview Sections' onPressDelegate={NavigationActions.listviewSectionsExample} />
        </View>
      </View>
    )
  }
